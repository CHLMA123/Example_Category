...
- (void)setupCamera{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        _output.rectOfInterest = CGRectMake(_scanRect.origin.y/SCREEN_HEIGHT, _scanRect.origin.x/SCREEN_WIDTH, _scanRect.size.height/SCREEN_HEIGHT, _scanRect.size.width/SCREEN_WIDTH);
        /**
         // Session
